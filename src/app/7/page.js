        ...
        <>
            <div>
                ...
                <div className="flex justify-center">
                    <Link href="/6" className="m-12 content-center"> 이전 </Link>
                    <iframe width="1000" height="550" src="https://www.youtube.com/embed/Fw0tPIpmU5I" title="Time is Relative but It Doesn&#39;t Go Backwards - I Told You To Leave Me - Interstellar Movie 4K Scene" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <Link href="/8" className="ml-10 content-center"> 다음 </Link>
                </div>
                <div className="flex justify-center">
