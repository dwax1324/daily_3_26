        ...
        <>
            <div>
                ...
                <div className="flex justify-center">
                    <Link href="/23" className="m-12 content-center"> 이전 </Link>
                    <iframe width="1000" height="550" src="https://www.youtube.com/embed/YQ1g5M-rcB8" title="여러분의 시" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                ...
                <div className="flex justify-center">
                    ...
                    <div className={hint}> ㅈㄱ ㅅㅇㄷㅇ ㅅㅎ </div>
                </div>
