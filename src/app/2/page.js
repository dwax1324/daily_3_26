        ...
        <>
            <div>
                ...
                <div className="flex justify-center">
                    ...
                    <iframe width="1000" height="550" src="https://www.youtube.com/embed/Xqao2pRzWa0" title="달콤한인생 명장면" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    <Link href="/3" className="ml-10 content-center"> 다음 </Link>
                </div>
                <div className="flex justify-center">
